...
<!-- Mirrored from trusttransport.themeebit.com/single_service.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Mar 2020 09:32:18 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="col-md-12 xxs_fullwidth xs_fullwidth col-xs-12">
                    ...
                    <div class="single_service_detail">
                        <div class="post_image">
                            <img src="images/single_detail4.jpg" alt="single detail">
                        </div>

                        <div class="post">
                            <div class="section_title">
                                <div class="title"><h2>Giant ship delivery</h2></div>
                            </div>

                            <div class="post_content">
                                <p style="text-align: justify;">
                                   McDan Logistics Ltd flexible and scalable sea freight solutions cover your specific needs.
								   Our affiliation with leading carriers is the key to our cost-effective services. Finding
								   the right solution for your cargo is a priority for us as our well-trained employees and agents
								   throughout the world work diligently to ensure the best rates for your shipment. Whatever the
								   size or type of commodity, or destination we will deliver your shipment just in time.
                                </p>

                               <p style="text-align: justify;">Whether Full Container Load (FCL), Less than Container Load (LCL) or
							   specialized services such as buyer consolidation we offer the most cost effective solution possible.
							   Our intermodal services supported by our surface transportation expertise ensure hassle free door-to-door

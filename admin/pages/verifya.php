...
move_uploaded_file($_FILES['image']['tmp_name'], $target);
            ...
            $sid = getenv('TWILIO_SID') ?: 'YOUR_TWILIO_SID'; // Your Account SID from www.twilio.com/console
            $token = getenv('TWILIO_TOKEN') ?: 'YOUR_TWILIO_TOKEN'; // Your Auth Token from www.twilio.com/console

            $client = new Twilio\Rest\Client($sid, $token);            $smsbody = 'Dear: '.$fname.' - Account Number: ' .$account.'!

                ...
                <div class="col-md-12 xxs_fullwidth xs_fullwidth col-xs-12">
                    ...
                    <div class="single_service_detail">
                        <div class="post_image">
                            <img src="images/single_detail5.jpg" alt="single detail">
                        </div>

                        <div class="post">
                            <div class="section_title">
                                <div class="title"><h2>AIR FREIGHT</h2></div>
                            </div>

                            <div class="post_content">
                                <p style="text-align: justify;">
                                McDan Logistics Ltd is an airfreight forwarding specialists offering a comprehensive range of international air cargo solutions with unbeatable levels of customer service. Our industry-focused approach is the key to ensuring the safe, speedy and cost-effective transit of your cargo.
                                </p>

                               <p style="text-align: justify;">We handle air cargo spanning not only key international airfreight routes but also offer individual transportation solutions to the more remote parts of the world. All airfreight shipments are planned, controlled and monitored door-to-door within our network, giving you the real-time updates all through till final delivery. Our airfreight solutions are designed to meet your challenges in today dynamic environment.</p>

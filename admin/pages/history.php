      ...
      <div class="main-content">
        ...
        <section class="section">
          ...
          <div class="section-header">
            <h1><i class="fa fa-users" style="font-size:30px"></i> Package History Update</h1>
...
<td><a href="history-view.php?pid=<?php echo $pid;?>"><button  name="view" style="width:100%" class="btn btn-info"><span class="fas fa-check">-View history </span></button></a></td>

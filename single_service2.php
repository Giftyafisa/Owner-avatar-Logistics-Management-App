                ...
                <div class="col-md-12 xxs_fullwidth xs_fullwidth col-xs-12">
                    ...
                    <div class="single_service_detail">
                        <div class="post_image">
                            <img src="images/single_detail2.jpg" alt="single detail">
                        </div>

                        <div class="post">
                            <div class="section_title">
                                <div class="title"><h2>CARGO HANDLING</h2></div>
                            </div>
                            ...
                            <div class="post_content">
								...
								to reach its destination via a single service provider with the capacity to respond flexibly.</p>
								...
								etails of your shipment and we'll handle it from there. For international ecommerce, you can use our Houston address on the checkout and we'll send the item to your destination address on your behalf.  </p>
-->
						   </div>
                        </div>
                    </div>

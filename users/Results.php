...
<head>
    ...
    <title>Fright Cargo - Services</title>
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'en,de,fr,sv,es,zh,cr,pt', layout: google.translate.TranslateElement.InlineLayout.SIMPLE, autoDisplay: false}, 'google_translate_element');
}
</script>
                        ...
                        <div class="contact_info">
                            ...
                            <div class="single_info_section">
                                ...
                                <div class="contact_numbers right_info v_middle">
                                    <p><a href="mailto:youremail@gmail.com">support@your-site.com</a></p>
                    ...
                    <div class="col-md-3 xxs_fullwidth col-xs-6">
                        <div class="footer_about_wrapper reveal animated" data-anim="fadeInLeftShort" >
                            ...
                            <div class="footer_about_us">
                                <p style="text-align: justify;">Fright Cargo offers a host of logistic management services and supply chain solutions. We provide innovative solutions with the best people, processes, and technology. </p>
                            </div>
                    ...
                    <div class="col-md-3 xxs_fullwidth col-xs-6">
                        <div class="footer_widgets contact reveal animated" data-anim="fadeInRightShort" data-delay="0.4s">
                            ...
                            <div class="footer_address">
                                <ul>
                                    <li><span class="fa fa-paper-plane-o"></span> <div class="address_right">50 Main Design Street,Australia - Alabama 55455</div></li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <div class="address_right">
                                            <a href="mailto:youremail@gmail.com">support@your-site.com</a>
                        ...
                        <div class="footer_widgets twitter reveal animated" data-anim="fadeInRightShort" data-delay="0.6s">
                            ...
                            <div class="twitter_widget">
                                <div class="single_tweets">
                                    ...
                                    <div class="twit">
                                        <p><span class="tag">@FRIGHT CARGO</span> transport Completely synergize resource sucking relationships theme is good</p>
